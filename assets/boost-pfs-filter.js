...
//       '{{itemVendor}}{{itemTitleWrapper}}{{itemRating}}{{itemSwatch}}{{itemPrice}}' :
//       '{{itemPrice}}{{itemTitleWrapper}}{{itemRating}}{{itemVendor}}{{itemSwatch}}';
    var itemInfoHtml = boostPFSConfig.custom.product_price_position == 'after_title' ?
      '{{itemVendor}}{{itemTitleWrapper}}{{itemReviews}}{{itemSwatch}}{{itemPrice}}' :
      '{{itemReviews}}{{itemPrice}}{{itemTitleWrapper}}{{itemVendor}}{{itemSwatch}}';
    ...
    // Add Loox Rating
    itemHtml = itemHtml.replace(/{{itemRating}}/g, buildRating(data));
  ...
  function buildRating(data) {
    var ratingHtml = '';
    if (window.hasOwnProperty('productRatings')) {
    var avgRating = window.productRatings[`${data.id}`].avg_rating;
    var numReviews = window.productRatings[`${data.id}`].num_reviews;
    
    var ratingHtml = `<div class="loox-rating" data-id="${data.id}" data-rating="${avgRating}" data-raters="${numReviews}"></div>`;
    }
